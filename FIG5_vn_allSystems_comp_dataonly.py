...
data = {
	"vn_pp":ROOT.TFile("data/fout_vn_28jun2023.root","read"), # pp 1<pT<2 GeV
...
plotParams = {
	"vn_pp":{"color":"k","fmt":"o","markersize":5.5,"label":"pp 13 TeV, $1<p_\\mathrm{T}<2\\,\\mathrm{GeV}/c$","labelLegendId":0},
	"vn_pp_14":{"color":"r","fmt":"o","mfc":"none","markersize":5.5,"label":"pp 13 TeV, $1<p_\\mathrm{T}<4\\,\\mathrm{GeV}/c$","labelLegendId":0},
	"vn_pPb_v0a_14":{"color":"b","fmt":"s","mfc":"none","markersize":5.5,"label":"p$-$Pb 5.02 TeV, $1<p_\\mathrm{T}<4\\,\\mathrm{GeV}/c$","labelLegendId":0},
}	
...
plot = JPyPlotRatio.JPyPlotRatio(panels=(nrow,ncol),
	...
	legendLoc={0:(0.52,0.20),1:(0.45,0.17)},
	axisLabelSize=12,tickLabelSize=12,legendSize=11,xlabel=xtitle[0],ylabel=ytitle,ylabelRight=ytitle[1]);

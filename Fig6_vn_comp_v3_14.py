...
#xtitle = ["$N_\\mathrm{ch}$",""];
ytitle = ["$V_{3}$"," $2Y_\\mathrm{frag}^\\mathrm{away}/Y_\\mathrm{frag}^\\mathrm{near}$"];
...
plot.GetPlot().text(0.55,0.2,"$1 < p_\\mathrm{T} < 4 \\,\\mathrm{GeV}/c$",fontsize=14);
...
plot.Save("figs/Fig6_v3Mult_14.pdf");
plot.Save("figs/Fig6_v3Mult_14.png");
plot.Show();

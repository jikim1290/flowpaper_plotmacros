...
toptitle = "ALICE pPb $\\sqrt{s_\\mathrm{NN}}=5.02\\,\\mathrm{TeV}$";
...
for si,s in enumerate(species):
	...
	dataPlots["502",s,"ptmean"] = plot.Add(1,(dat[:,3],dat[:,6]),fmt=ms[si],mfc="none",color=colors[si],label=labels[si]);
...
plot.Save("figs/dndeta_meanpT_pPb.pdf");
plot.Show();

...
data = {
	"hv2_pp_mult_1_4_ptrange":ROOT.TFile("data/Final_Items.root","read"),
#	"vn_pPb_zna":ROOT.TFile("data/Final_Items.root","read"),
#	"vn_pPb_v0a":ROOT.TFile("data/Final_Items.root","read"),
	"hv2_pPb_mult_1_4_ptrange":ROOT.TFile("data/fout_v2_pPb_v1.root","read"),
...
plotParams = {
	"hv2_pp_mult_1_4_ptrange":{"color":"k","fmt":"o","markersize":5.0,"label":"pp $\\sqrt{s}$ = 13 TeV","labelLegendId":0},
	"hv2_pPb_mult_1_4_ptrange":{"color":"r","fmt":"*","mfc":"none","markersize":5.0,"label":"p$-$Pb $\\sqrt{s_\\mathrm{NN}}$ = 5.02 TeV","labelLegendId":0},
...
plot.Save("figs/Fig6_v2Mult_allSystemsComp_nocorr.pdf");
plot.Save("figs/Fig6_v2Mult_allSystemsComp_nocorr.png");
plot.Show();

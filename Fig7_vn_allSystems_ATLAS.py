...
#	"vn_pPb_v0a":{"color":"k","fmt":"*","markersize":5.0,"label":"p$-$Pb $\\sqrt{s_\\mathrm{NN}}$ = 5.02 TeV ","labelLegendId":0},
	"vn_pPb_v0a_14":{"color":"r","fmt":"s","mfc":"none","markersize":5.0,"label":"p$-$Pb 5.02 TeV","labelLegendId":0},
#	"vn_pPb_pub":{"color":"orange","fmt":"p","mfc":"none","markersize":5.0,"label":"$V_{2}\\{2,|\Delta\eta|<1.4\\}$: pPb $\\sqrt{s_\\mathrm{NN}}$ = 5.02 TeV","labelLegendId":1},
	...
	"vn_pp_atl":{"color":"black","fmt":"o","markersize":5.0,"label":"ATLAS: pp 13 TeV","labelLegendId":2},
	"vn_pPb_atl":{"color":"black","fmt":"s","mfc":"none","markersize":5.0,"label":"ATLAS: p$-$Pb 5.02 TeV","labelLegendId":2},
	"vn_pp_pseudo":{"color":"red","fmt":"o","mfc":"none","markersize":5.0,"label":"pp 1-4 GeV ","labelLegendId":0},
	"vn_pPb_v0a_pseudo":{"color":"red","fmt":"*","mfc":"none","markersize":5.0,"label":"p$-$Pb 1-4 GeV","labelLegendId":0},
	"ptBin1":{"color":"black",}
...
plot = JPyPlotRatio.JPyPlotRatio(panels=(nrow,ncol),
	...
	#legendPanel={0:0},
        legendLoc={0:(0.27,0.12),1:(0.75,0.16),2:(0.65,0.12)},
...
plot.GetPlot().text(0.25,0.3,"$1.6<|\Delta\eta|<1.8$",fontsize=8);
#plot.GetPlot().text(0.35,0.3,"$1 < p_\\mathrm{T} < 2.0 \\,\\mathrm{GeV}/c$",fontsize=8);
plot.GetPlot().text(0.25,0.26,"$1 < p_\\mathrm{T} < 4.0 \\,\\mathrm{GeV}/c$",fontsize=8);
...
plot.GetPlot().text(0.5,0.34,"$2.0<|\Delta\eta|<5.0$",fontsize=8);
plot.GetPlot().text(0.5,0.3,"$1.0 < p_\\mathrm{T} < 5 \\,\\mathrm{GeV}/c$",fontsize=8);
plot.GetPlot().text(0.5,0.26,"$N_\\mathrm{ch,ATLAS}^{rec}, |\eta|<2.5$, $p_\\mathrm{T}>0.4\\,\\mathrm{GeV}/c$",fontsize=8);
#plot.GetPlot().text(0.19,0.14,dataDetail[0],fontsize=11);


plot.Plot();

plot.Save("figs/Fig7_v2Mult_allSystemsATLAS.pdf");
#plot.Save("figs/Fig6_v2Mult_ourresult.pdf");
plot.Save("figs/Fig6_v2Mult_allSystemsATLAS.png");
